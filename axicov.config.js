...
module.exports = {
  ...
  params: {
    ...
    aiFeatures: ["disease-detection", "chat-assistant", "voice-assistant", "image-analysis"],
    models: ["tensorflow", "gemini-2.0-flash-exp"]
  },
  port: 5000,
  ...
  workflows: {
    ...
    "chat-text": {
      ...
      description: "AI farming advisor for crop cultivation, weather, disease prevention, and agriculture best practices",
    ...
    "image-analysis": {
      ...
      description: "Combines TensorFlow disease detection with Gemini vision for comprehensive plant health analysis",
    ...
    "voice-command": {
      ...
      description: "Interprets voice commands and determines navigation/actions",
    ...
    "live-voice": {
      ...
      description: "Real-time voice conversation with access to weather, market, and news data",
