...
export default function CropPrediction() {
  ...
  const getFertilizerAdvice = async () => {
    ...
    try {
      // Generate basic fertilizer advice based on crop type
      const basicAdvice = `For ${selectedCrop}, maintain balanced NPK levels. Based on your soil parameters (N:${soilParams.nitrogen}, P:${soilParams.phosphorus}, K:${soilParams.potassium}), consider applying balanced fertilizer and monitoring soil health regularly.`;

      setFertilizer(basicAdvice);
    } catch (error) {
      console.error('Error generating fertilizer advice:', error);
      alert('Failed to generate fertilizer advice. Please try again.');
    } finally {
